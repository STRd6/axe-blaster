(function(pkg) {
  ...
  "distribution": {
    ...
    "experiments/intro": {
      ...
      "content": "(function() {\n  var Container, Point, Rectangle, Sprite, Text, Texture, dt, gameLoop, height, letterSprites, loaded, loader, name, renderer, stage, t, width, _ref;\n\n  require(\"../setup\");\n\n  _ref = require(\"../pixie\"), width = _ref.width, height = _ref.height, name = _ref.name;\n\n  loader = PIXI.loader, Container = PIXI.Container, Point = PIXI.Point, Rectangle = PIXI.Rectangle, Sprite = PIXI.Sprite, Text = PIXI.Text, Texture = PIXI.Texture;\n\n  renderer = PIXI.autoDetectRenderer(width, height, {\n    antialias: false,\n    transparent: false,\n    resolution: 1\n  });\n\n  renderer.backgroundColor = 0xFFFFFF;\n\n  document.body.appendChild(renderer.view);\n\n  stage = new Container();\n\n  letterSprites = \"Whimsy.Space\".split(\"\").map(function(letter, i) {\n    var shift, text;\n    text = new Text(letter, {\n      align: \"center\",\n      fill: \"black\",\n      fontSize: \"128px\",\n      fontFamily: \"courier\"\n    });\n    shift = (i * 3 + 37) % 12;\n    text.x = (i + 3) * width / 18;\n    text.y = height / 2 + shift;\n    text.visible = true;\n    stage.addChild(text);\n    return text;\n  });\n\n  global.letterSprites = letterSprites;\n\n  dt = 1 / 60;\n\n  t = 0;\n\n  loaded = false;\n\n  gameLoop = function() {\n    requestAnimationFrame(gameLoop);\n    letterSprites.forEach(function(letter, i) {\n      return letter.visible = i / 4 <= t;\n    });\n    renderer.render(stage);\n    return t += dt;\n  };\n\n  gameLoop();\n\n  loader.add([\n    {\n      name: \"typing\",\n      url: \"https://danielx.whimsy.space/axe-blaster/type.ogg\"\n    }\n  ]).load(function() {\n    loaded = true;\n    return loader.resources.typing.data.play();\n  });\n\n}).call(this);\n",
      "type": "blob"
    }
  },
  "progenitor": {
