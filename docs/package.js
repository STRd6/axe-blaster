(function(pkg) {
  ...
  "distribution": {
    ...
    "models/player": {
      "path": "models/player",
      "content": "(function() {\n  var Point, Rectangle, Sprite, abs, collides, getTileBounds, hitTestRectangle, sign, testRect;\n\n  Point = PIXI.Point, Rectangle = PIXI.Rectangle, Sprite = PIXI.Sprite;\n\n  abs = Math.abs, sign = Math.sign;\n\n  hitTestRectangle = require(\"../lib/util\").hitTestRectangle;\n\n  module.exports = function(texture) {\n    var bounds, gravity, player, position, residual, velocity;\n    player = new Sprite(texture);\n    position = player.position;\n    bounds = new Rectangle;\n    residual = new Point;\n    velocity = new Point;\n    gravity = 3600;\n    player.x = 256;\n    player.y = 256;\n    player.scale.set(0.5);\n    player.anchor.set(0.5);\n    player.update = function(dt, collisionGeometry) {\n      var dx, dy, n, signX, signY, _results;\n      velocity.y += gravity * dt;\n      dx = velocity.x * dt;\n      dy = velocity.y * dt;\n      bounds.x = player.x - player.width / 2;\n      bounds.y = player.y - player.height / 2;\n      bounds.width = player.width;\n      bounds.height = player.height;\n      signX = sign(dx);\n      n = abs(dx | 0);\n      while (n > 0) {\n        n--;\n        bounds.x += signX;\n        if (!collides(bounds, collisionGeometry)) {\n          player.x += signX;\n        } else {\n          velocity.x = 0;\n        }\n      }\n      signY = sign(dy);\n      n = abs(dy | 0);\n      _results = [];\n      while (n > 0) {\n        n--;\n        bounds.y += signY;\n        if (!collides(bounds, collisionGeometry)) {\n          _results.push(player.y += signY);\n        } else {\n          _results.push(velocity.y = 0);\n        }\n      }\n      return _results;\n    };\n    Object.assign(player, {\n      bounds: bounds,\n      velocity: velocity\n    });\n    return player;\n  };\n\n  getTileBounds = function(tile, rect) {\n    rect.x = tile.x;\n    rect.y = tile.y;\n    rect.width = tile.width;\n    rect.height = tile.height;\n    return rect;\n  };\n\n  testRect = new Rectangle;\n\n  collides = function(bounds, objects) {\n    var i, length, result;\n    i = 0;\n    length = objects.length;\n    while (i < length) {\n      result = hitTestRectangle(bounds, getTileBounds(objects[i], testRect));\n      if (result) {\n        return result;\n      }\n      i += 1;\n    }\n  };\n\n}).call(this);\n",
      "type": "blob"
    },
    "pixie": {
      "path": "pixie",
